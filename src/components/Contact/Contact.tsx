  ...
  const contactInfo = [
    {
      ...
      title: 'Email',
      details: 'contato@underbug.com.br',
      link: 'mailto:contato@underbug.com.br'
    },
    {
      icon: <Phone className="h-6 w-6 text-cyan-400" />,
      title: 'Telefone',
      details: '+55 (11) 0000-0000',
      link: 'tel:+551100000000'
    },
    {
    ...
    },
    {
      ...
      title: 'Horário',
      details: 'Segunda a Sexta: 09:00 - 18:00',
      link: null
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="max-w-2xl mx-auto text-gray-300">
            Entre em contato com nossa equipe de especialistas para saber como podemos ajudar a proteger o seu negócio.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div>
            <div className="bg-gray-900 rounded-2xl p-8 shadow-xl">
              ...
              <div className="mt-8">
                <h4 className="text-lg font-medium text-white mb-4">Nos Siga</h4>
